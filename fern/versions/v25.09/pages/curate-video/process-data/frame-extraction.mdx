...
[Embeddings](/curate-video/process-data/embeddings) and [aesthetic filtering](/curate-video/process-data/filtering) require frames. If you need saved media files, frame extraction is optional.
...
- **Embeddings**: InternVideo2 and Cosmos‑Embed1 expect frames at specific rates. Refer to [Embeddings](/curate-video/process-data/embeddings).
